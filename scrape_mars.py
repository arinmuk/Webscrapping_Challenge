...
def scrape():
        ...
        search_str='Opportunity Rover'
        for img_results in img_res:
                    #print(img_results)
                    #print('-----------')
                    #print(img_results.text)
                    #print('+++++++++++++++++++++++++++')
                    #print(img_results["data-fancybox-href"])
                    #print('+++++++++++++============')
                    if (search_str in img_results.text):
                        url_par=img_results["data-fancybox-href"]
                        picture_url='https://www.jpl.nasa.gov' + url_par
                        #print(picture_url)
                        #print('#########')
